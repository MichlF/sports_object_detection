# see https://dev.to/stephan007/open-source-sports-video-analysis-using-maching-learning-2ag4
# see https://learnopencv.com/homography-examples-using-opencv-python-c/
"""A Homography is a transformation ( a 3×3 matrix ) that maps the points in one 
image to the corresponding points in the other image. Useful for mapping player location
onto a 2D image of the court"""

#! NOT DONE: JUST EXAMPLE:
